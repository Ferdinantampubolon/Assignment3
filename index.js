            ...
            node.innerHTML = `
                <div class="card mb-3 text-bg-dark" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-danger" onclick="deleteData(${data[i].id})"><i class="bi bi-trash3-fill"></i></a>
                        <a href="#" class="btn btn-warning" onclick="editData(${data[i].id})"><i class="bi bi-pencil-fill"></i></a>
                        <a href="#" class="btn btn-success" onclick="detailData(${data[i].id})"><i class="bi bi-eye-fill"></i></a>
                    </div>
                </div>
            `
